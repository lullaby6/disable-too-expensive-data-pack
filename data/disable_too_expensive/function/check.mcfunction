...
execute store result score @s disable_too_expensive.repair_cost run data get entity @n[tag=disable_too_expensive.temp] HandItems[0].components."minecraft:repair_cost"
